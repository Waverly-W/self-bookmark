...
1. 返回格式必须是: "名称 | 功能描述"
2. 名称处理规则：
   - 对于网站/工具/平台：保留最核心的网站/资源名称，去除无用词汇
   - 对于文章/教程/文档/曲谱等具体内容：保留原有标题的主要含义，可以适当精简但不改变核心内容
3. 功能描述：
   - 对于网站/工具/平台：用10字以内简述其主要功能或作用
   - 对于文章/教程/文档/曲谱等：用10字以内说明内容类型和主题
4. 使用简体中文
5. 确保分隔符是英文竖线加空格" | "
6. 示例：
   网站/平台类：
